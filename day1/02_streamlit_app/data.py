...
SAMPLE_QUESTIONS_DATA = [
    {
        ...
        "answer_2": "リスト内包表記は、Pythonのリストを生成するための簡潔な方法で、`[expression for item in iterable]`の形式で書きます。",
    ...
    },
    {
        ...
        "answer_2": "過学習とは、モデルが訓練データに合わせすぎてしまい、新しいデータへの対応力が低くなる現象です。",
    ...
    },
    {
        ...
        "answer_2": "量子コンピュータは、キュービットを使い、同時に複数の状態を持つことで並列処理を行う計算機です。",
    ...
    },
    {
        ...
        "answer_2": "Streamlitは、PythonだけでWebアプリを簡単に作れるツールで、主にデータサイエンスに使われます。",
    ...
    },
    {
        ...
        "answer_2": "ブロックチェーンは、ブロックに情報を記録し、暗号技術で連結することで改ざんを防ぐ技術です。",
    ...
    },
    {
        ...
        "answer_2": "ディープラーニングは、深い層を持つニューラルネットワークを使って、複雑なパターンを学習する機械学習手法です。",
    ...
    },
    {
        ...
        "answer_2": "SQLインジェクションは、悪意あるSQLを入力してデータベースを不正に操作する攻撃です。",
    ...
    },
    {
        ...
        "answer_2": "NFTは、ブロックチェーン上に存在する唯一無二のデジタルアイテムを表すトークンです。",
    ...
    },
    {
        ...
        "answer_2": "Pythonのデコレータは、関数に機能を追加するための構文で、@を使って定義の上に書きます。",
    ...
    },
    {
        ...
        "answer_2": "コンテナは、アプリケーションとその環境をまとめて動かせる仕組みで、どこでも同じように実行できます。",
    ...
    try:
        ...
        for item in SAMPLE_QUESTIONS_DATA:
            ...
            save_to_db(
                ...
                response_time_1=item["response_time_1"],
                response_time_2=item["response_time_2"],
            )
            added_count += 1
